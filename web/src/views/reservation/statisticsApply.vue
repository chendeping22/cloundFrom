  ...
  <div class="container"
    ...
    <div class="info-table"
      ...
      <el-table tooltip-effect="light"
                ...
                :default-sort="{prop: 'SHOW_POSITION', order: 'ascending'}"
                :data="data"
                border
                style="width: 100%;"
                ref="singleTable"
...
export default {
  ...
  created () {
    ...
    param.stat_SP_name = 'stat_StatisticsApplyRes'
    param.action = 1
    // self.getData(param)
    // self.getStudyData()
  ...
  methods: {
    filterMethod (query) {
      //      console.log(query,this.searchForm.check_site)
      if (query !== '') {
